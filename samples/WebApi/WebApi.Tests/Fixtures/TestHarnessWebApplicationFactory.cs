...
/// but no message broker. Only the shared PostgreSQL container is consumed (with a database per test class).
/// </summary>
public sealed class TestHarnessWebApplicationFactory(AppContainerHost containerHost) : BaseWebApplicationFactory<Program>(containerHost)
{
