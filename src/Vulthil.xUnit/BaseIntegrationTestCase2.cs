...
public abstract class BaseIntegrationTestCase2<TFactory, TEntryPoint> : IAsyncLifetime
    where TFactory : BaseWebApplicationFactory2<TEntryPoint>, new()
    where TEntryPoint : class
{
    ...
    protected BaseIntegrationTestCase2(TestFixture testFixture, ITestOutputHelper? testOutputHelper = null)
    {
